...
public class GossipPeer implements IPeer {
    ...
    private static HeartbeatThread hrt;
    ...
    public GossipPeer(String name){
        ...
        hrt = new HeartbeatThread(this, name);

        Thread hrtThread = new Thread(hrt);
    ...
    public static void main(String[] args){
        ...
        GossipPeer peer = new GossipPeer(name);
    ...
    public void receiveFrom(String peer, String msg){
        ...
        System.out.println(name + " received message from: " + peer);
        selectToKeep(msg);
        ...
        synchronized (lock) {
            try {
                ...
                while (reader.hasNextLine()) {
                    ...
                    if(lineFromFile.contains("alive") && msg.contains("alive")){
                        // refreshes counter for living message
                        msg = incomPeer + " is alive.";
                        dict.put(incomPeer, 0);
                    }
